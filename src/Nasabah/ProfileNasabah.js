...
export default class ProfileNasabah extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: {},
          ...
          <ScrollView
            ...
            <View style={styles.container2}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  this.props.navigation.navigate('Profilenasabah', {
                ...
                <Text style={styles.txtedit}>Profile</Text>
              </TouchableOpacity>
              ...
              <Text style={styles.txtedit}>Email</Text>
            </TouchableOpacity> */}
              ...
              <TouchableOpacity
                ...
                <View style={styles.viewedit}>
                  <Image
                    source={require('../Assets/blackkey.png')}
                    style={styles.imgedit}
                  />
                </View>
                <Text style={styles.txtedit}>Password</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                <Text style={styles.txtedit}>ranking</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.touchedit}
                onPress={() => this.logOut()}>
                ...
                <Text style={styles.txtedit}>Keluar</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        )}
