...
import {styles} from './Styledatajemput';
...
class Datajemput extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  getDatajemput() {
    ...
    fetch('https://nsj-trash.herokuapp.com/api/pengurus1/datajemput', {
      method: 'GET',
      headers: {
  ...
  terimaJemput() {
    fetch(
      `https://nsj-trash.herokuapp.com/api/pengurus1/terimajemput/${
        this.state.data[this.state.terima].id
      }`,
      {
        method: 'GET',
        headers: {
  ...
  tolakJemput() {
    fetch(
      `https://nsj-trash.herokuapp.com/api/pengurus1/tolakjemput/${
        this.state.data[this.state.tolak].id
      }`,
      {
        method: 'GET',
        headers: {
  ...
  setModalVisible = (visible, index) => {
    this.setState({modalVisible: visible, tolak: index});
  };
  setModalVisible2 = (visible, index) => {
    this.setState({modalVisible2: visible, terima: index});
  };
  render() {
    return (
          ...
          {this.state.loading !== false ? (
            ...
            <View>
              <View style={styles.header}>
                ...
                <Text style={styles.txtback}>Datajemput</Text>
              </View>
              <View>
                <View>
                    ...
                    <View>
                      <View>
                        {this.state.data.map((item, index) => {
                          return (
                            <View key={index} style={styles.touchdata}>
                              <View style={styles.view1}>
                                <TouchableOpacity
                                  style={styles.viewimgfoto}
                                  onPress={() =>
                              ...
                              <View style={styles.view2}>
                                ...
                                <Text
                                  ...
                                  onPress={() =>
                                    Linking.openURL(item.url_alamat)
                                  }>
                                  {item.alamat}
                                </Text>
                              </View>
                              <View style={styles.view3}>
                                <View style={{width: '32%', height: 75}}></View>
                                <TouchableOpacity
                                ...
                                <TouchableOpacity
                                  ...
                                  <Text style={styles.txtterima}>Terima</Text>
                                </TouchableOpacity>
                              </View>
                            </View>
                          );
            ...
            <View style={styles.containermodal}>
              <View style={styles.viewmodal}>
                ...
                <View style={styles.viewtanya}>
                  ...
                  <TouchableOpacity onPress={() => this.tolakJemput()}>
            ...
            <View style={styles.containermodal}>
              <View style={styles.viewmodal}>
                ...
                <View style={styles.viewtanya}>
                  ...
                  <TouchableOpacity onPress={() => this.terimaJemput()}>
                    <Text style={styles.txt}>Ya</Text>
                  </TouchableOpacity>
                </View>
              </View>
...
export default connect(mapStateToProps)(Datajemput);
