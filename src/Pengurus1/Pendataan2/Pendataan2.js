...
import {styles} from './Stylependataan2';
import {connect} from 'react-redux';
import LottieView from 'lottie-react-native';

// import AsyncStorage from '@react-native-community/async-storage';

class Pendataan2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  getKontak() {
    ...
    fetch('https://nsj-trash.herokuapp.com/api/pengurus1/daftarnasabah', {
      method: 'GET',
      headers: {
          ...
          <ScrollView>
            <View style={styles.header}>
              ...
              <View style={styles.viewname}>
                <Text style={styles.txtback}>Nasabah</Text>
                <TouchableOpacity
                  style={styles.touchsearch}
                  onPress={() => this.props.navigation.navigate('Pencarian2')}>
                  <Image
              ...
              return (
                <View key={index} style={{marginTop: '0.5%'}}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      this.props.navigation.navigate('Pendataanantar', {
                        item: item,
                      })
                    }>
                    <Image
...
export default connect(mapStateToProps)(Pendataan2);
