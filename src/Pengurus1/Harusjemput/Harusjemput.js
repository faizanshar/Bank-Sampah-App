...
import {styles} from './Styleharusjemput';
...
class Harusjemput extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  getHarusjemput() {
    ...
    fetch('https://nsj-trash.herokuapp.com/api/pengurus1/harusjemput', {
      method: 'GET',
      headers: {
                          ...
                          return (
                            <View key={index} style={styles.touchdata}>
                              ...
                              <View style={styles.view3}>
                                <View style={{width: '12%', height: 75}}></View>
                                <TouchableOpacity
                                ...
                                <TouchableOpacity
                                  ...
                                  <Text style={styles.txtdata1}>Data</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
...
export default connect(mapStateToProps)(Harusjemput);
