...
class Chatid1 extends Component {
  ...
  getPesan() {
    ...
    fetch(
      `https://nsj-trash.herokuapp.com/api/pesan/${this.props.route.params.item.user_id}`,
      {
        method: 'GET',
        headers: {
        ...
        {/* {this.state.loading !== false ? (
          ...
          <View style={{flex:1}}>
            <View style={styles.header}>
              ...
              <Image
                source={
                  this.props.route.params.item.foto_user
                    ? {uri: this.props.route.params.item.foto_user}
                    : {
                        uri:
              ...
              <Text style={styles.txt}>
                {this.props.route.params.item.user_nama}
              </Text>
            </View>
            <ScrollView
              style={{width: '100%'}}
