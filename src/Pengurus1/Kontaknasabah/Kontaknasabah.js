...
import {styles} from './Stylekontaknasabah';
import {connect} from 'react-redux';
import LottieView from 'lottie-react-native';

// import AsyncStorage from '@react-native-community/async-storage';

class Kontaknasabah extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
          ...
          <ScrollView>
            <View style={styles.header}>
              ...
              <View style={styles.viewname}>
                <Text style={styles.txtback}>Kontaknasabah</Text>
                <TouchableOpacity
...
export default connect(mapStateToProps)(Kontaknasabah);
